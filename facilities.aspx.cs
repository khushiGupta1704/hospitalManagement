...
public partial class facilities : System.Web.UI.Page
{
    ...
    public int DisplayRepeter()
    {
        ...
        dt = verma.Show_Data("select * from facilities where status=1 order by position");
        FacilityRepeater.DataSource = dt;
        FacilityRepeater.DataBind();
        ...
        FacilityRepeater.DataSource = pds;
        FacilityRepeater.DataBind();
