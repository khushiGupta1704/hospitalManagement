...
<h2 class="" style="padding-top:30px">Blogs</h2>
...
<div class="row d-flex">
   ...
   <ItemTemplate>
        ...
        <a href="http://aastha.omtechnoware.com/BlogDetail/<%#Eval("id")%>" class="block-20" style='background-image: url(<%#Eval("image")%>);'>
        </a>
        ...
        <h3 class="heading"><a href="http://aastha.omtechnoware.com/BlogDetail/<%#Eval("id")%>"><%#Eval("title")%></a></h3>
